          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            >
              <div className="relative h-64 w-full overflow-hidden">
                <Image src="/images/event_1.jpg" alt={p.eventAlt} fill sizes="(max-width:768px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute top-4 left-4 rounded-xl bg-white/95 backdrop-blur-md px-4 py-2 text-center shadow-lg">
                  <div className="text-xs font-bold uppercase text-blue-600">{p.event1Month}</div>
              ...
              <div className="p-8 sm:p-10">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">{p.event1Desc}</p>
            ...
            >
              <div className="relative h-64 w-full overflow-hidden">
                <Image src="/images/event_2.jpg" alt={p.eventAlt} fill sizes="(max-width:768px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute top-4 left-4 rounded-xl bg-white/95 backdrop-blur-md px-4 py-2 text-center shadow-lg">
                  <div className="text-xs font-bold uppercase text-blue-600">{p.event2Month}</div>
              ...
              <div className="p-8 sm:p-10">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">{p.event2Desc}</p>
                <div className="flex flex-col gap-3 text-sm font-medium text-slate-500">
                  <div className="flex items-center gap-2">
                    <Clock className="h-4 w-4 text-amber-500" aria-hidden="true" />
