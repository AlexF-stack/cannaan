        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              <motion.span
                variants={fadeUp}
                className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-blue-600 mb-4"
              >
                <span className="block h-0.5 w-8 bg-amber-400" /> {p.visionariesTitle}
              </motion.span>
      ...
      <section id="identite" className="bg-slate-50 px-6 py-24 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-14">
            <motion.span
              variants={fadeUp}
              className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-blue-600 mb-3 justify-center"
            >
              <span className="block h-0.5 w-8 bg-amber-400" /> {p.identityBadge}
            </motion.span>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="mb-12 grid lg:grid-cols-2 gap-8 items-end">
            <div>
              <motion.span variants={fadeUp} className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-blue-600 mb-3">
                <span className="block h-0.5 w-8 bg-amber-400" /> {p.programLabel}
              </motion.span>
              <motion.h2 variants={fadeUp} className="font-[var(--font-heading)] text-4xl font-extrabold text-slate-900">
                {dict.events.title}
              </motion.h2>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-4">
              <motion.div
                ...
                viewport={{ once: true }}
                className="rounded-2xl bg-blue-600 p-7 text-white"
              >
              ...
              <motion.div
                ...
                className="rounded-2xl bg-amber-400 p-5"
              >
              ...
              <motion.div
                ...
                className="rounded-2xl bg-slate-800 p-5 text-white"
              >
